...
def read_calib_file():
    ...
    calib_file = readsav('demcmc_FIP/eis_calibration/eis_calib_warren_2014.sav')
...
def eis_effective_area_read(short=False, long=False):
    if short:
        preflight = readsav('demcmc_FIP/eis_calibration/preflight_calib_short.sav')
    if long:
        preflight = readsav('demcmc_FIP/eis_calibration/preflight_calib_long.sav')
    wave = preflight['wave']
    ea = preflight['ea']
    return wave, ea
